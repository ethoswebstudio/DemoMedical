import{_ as A}from"./nselect.vue-mubgmzer.js";import{u as E,c as F,a as W,_ as q}from"./gk0e56xz.js";import{_ as z}from"./nswitch.vue-bpoo3j7g.js";import{_ as J}from"./ndropdown.vue-pel467mt.js";import{_ as O}from"./ncode-block.vue-ctkw4rc7.js";import{_ as G}from"./ndrawer.vue-jkaykvna.js";import{A as h,d as x}from"./vendor/quicktype-core-dsrweb93.js";import{p as H,k,q as N,x as C,V as c,U as m,a3 as n,a5 as d,a4 as r,S as i,J as f,F as D,ag as S,u as _,aa as V,ae as K}from"./vendor/json-editor-vue-m9gzt21j.js";import"./vendor/unocss-oyl7opas.js";import"./vendor/shiki-imfwxqoq.js";import"./client-oeqdl4pb.js";const M={border:"b base",flex:"~ items-center gap-2",sticky:"","left-0":"","right-0":"","top-0":"","z-1":"","bg-base":"",p3:""},P={key:0,flex:"~ items-center justify-center",absolute:"","bottom--1":"","right--2":"","h-4":"","w-4":"","rounded-full":"","bg-lime:30":"","text-8px":""},Q={flex:"~ col","w-100":"","of-auto":"",py2:""},R={"text-xs":"",capitalize:"",op75:""},ie=H({__name:"DataSchemaDrawer",setup(X){const s=E(),b=k(0),l=k("TypeScript"),v=N(()=>h.all.find(e=>e.displayName===l.value)),o=k(v.value?.optionDefinitions.filter(e=>typeof e.defaultValue=="boolean")),y=F(async()=>{if(b.value,!s.value)return"";const e=x.jsonInputForTargetLanguage(l.value);await e.addSource({name:s.value.name??"Data",samples:[s.value.input]});const t=new x.InputData;return t.addInput(e),(await x.quicktype({inputData:t,lang:l.value,rendererOptions:o.value?.reduce((u,p)=>(u[p.name]=p.defaultValue,u),{})})).lines.join(`
